...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference('Interest.count') do
      post interests_url, params: { interest: { facebook_id: @interest.facebook_id, name: @interest.name } }, as: :json
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { facebook_id: @interest.facebook_id, name: @interest.name } }, as: :json
    assert_response 200
  end
